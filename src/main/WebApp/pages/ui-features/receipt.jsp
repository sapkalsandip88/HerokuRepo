...
<script type="text/javascript">
	function validate() {
		if (document.getElementById("recfrom").value == "") {
			alert("Please enter Received from..!!");
			return false;
		}
		if (document.getElementById("recamt").value == "0") {
			alert("Please enter Received Amt..!!");
			return false;
		}
		if (document.getElementById("paydate").value == "0") {
				...
				<div class="content-wrapper">
					...
					<div class="row">
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Receipt Module</h4>
									<form class="forms-sample">
										<div class="form-group">
											<label for="recfrom">Received From</label> <input type="text"
												class="form-control" id="recfrom" placeholder="Name">
										</div>
										<div class="form-group">
											<label for="recamt">Amount</label> <input type="text"
												class="form-control" id="recamt" value="0">
										</div>
										<div class="form-group">
											<label for="paydate">Date</label> <input type="date"
												class="form-control" id="paydate" placeholder="dd/mm/yyyy">
										</div>
										<div class="form-group">
											<label for="mode">Mode Of Payment</label> <select
										...
										<div class="form-group">
											<label for="chqno">Cheque No.</label> <input type="text"
												class="form-control" id="chqno" placeholder="Name">
										</div>
										<div class="form-group">
											<label for="chqdate">Cheque Date</label> <input type="text"
												class="form-control" id="chqdate" placeholder="Name">
										</div>
										<div class="form-group">
											<label for="cbank">Cheque Bank</label> <input type="text"
												class="form-control" id="cbank" placeholder="Name">
										</div>
										<div class="form-group">
											<label for="cstatus">Cheque Status</label> <select
												class="form-control" id="cstatus">
										...
										<div class="form-group">
											<label for="cdbank">Chq/DD dropped at</label> <input
												type="text" class="form-control" id="cdbank"
												placeholder="Name">
										</div>
