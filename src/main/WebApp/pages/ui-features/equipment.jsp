...
function validate()
{
		...
		if(document.getElementById("noofunit").value=="")
		{
								...
								<div class="card-body">
									...
									<form class="forms-sample">
										<div class="form-group">
											<label for="eqname">Equipment Name</label> <input type="text"
												class="form-control" id="eqname" placeholder="Name">
										</div>
										<div class="form-group">
											<label for="refno">Reference No</label> <input type="text"
												class="form-control" id="refno" placeholder="Reference No">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="unittype">Unit Type</label> <select
										...
										<div class="form-group">
											<label for="noofunit">No. Of Unit</label> <input type="text"
												class="form-control" id="noofunit" value="0">
										</div>
										<div class="form-group">
