...
function validate()
{
  ...
  <body>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="../../category">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="catname" name = "catname" value="${categoryList.catname}">
                      </div>
                      <div class="form-group">
                        <label for="status">Status</label>
                        <select class="form-control" id="status" name ="status">
                          <option>${categoryList.status}</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  	 id="description" name="description" rows="4" value ="${categoryList.description}" ></textarea>
                      </div>
                      <div class="form-group">
                        <label for="brcode">Branch Code</label>
                        <input type="text" class="form-control" id="brcode" name = "brcode" value="${categoryList.brcode}">
                      </div>
                      <div class="form-group" hidden>
                        <label for="brcode">Catagory id</label>
                        <input type="text" class="form-control" id="cid" name = "cid" value="${categoryList.cid}">
                      </div>
	...
	<c:otherwise>
		<center><h2 style="color:red;margin-top:-150px;">No Course Found.</h2></center>
	</c:otherwise>
	</c:choose><br>
        <!-- main-panel ends -->
      </div>
