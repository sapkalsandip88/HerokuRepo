...
<script type="text/javascript">
	...
	function calTot()
	{
		var rgamt =document.getElementById("rgamt").value;
		var plamt =document.getElementById("plamt").value;
		var otamt =document.getElementById("otamt").value;
		var dscamt=document.getElementById("dscamt").value;
		var gtamt =(parseFloat(rgamt)+parseFloat(plamt)+parseFloat(otamt)-parseFloat(dscamt))
			
		document.getElementById("gtamt").value=gtamt;
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="../../index.html"> <span class="menu-title">Dashboard</span>
							<i class="mdi mdi-home menu-icon"></i>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						data-toggle="collapse" href="#ui-basic" aria-expanded="false"
						aria-controls="ui-basic"> <span class="menu-title">Masters</span>
						...
						<div class="collapse" id="ui-basic">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/member.jsp">Member</a></li>
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/staff.jsp">Staff</a></li>
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/equipment.jsp">Equipment</a></li>
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/packages.jsp">Packages</a></li>
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/user.jsp">User</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
					...
					<li class="nav-item"><a class="nav-link"
						href="../../pages/charts/chartjs.html"> <span
							class="menu-title">Charts</span> <i
									...
									<form class="forms-sample">
										<div class="form-group">
											<label for="mname">Member Name</label> <input type="text"
												class="form-control" id="mname" placeholder="Name">
										</div>
										<div class="form-group">
											<label for="interestedin">Interested in</label> <select
												class="form-control" id="interestedin">
												<option value="Weight Loss">Weight Loss</option>
												<option value="Weight Gain">Weight Gain</option>
												<option value="Body Buidling">Body Buidling</option>
										...
										<div class="form-group">
											<label for="plan">plan</label> <select class="form-control"
												id="plan">
												<option value="Weight Loss">Weight Loss</option>
												<option value="Weight Gain">Weight Gain</option>
												<option value="Body Buidling">Body Buidling</option>
										...
										<div class="form-group">
											<label for="batch">Batch</label> <select class="form-control"
												...
												<option value="After-Noon Batch">After-Noon Batch</option>
												<option value="Early Morning Batch">Early Morning
													Batch</option>
												<option value="Evening Batch">Evening Batch</option>
												<option value="Morning Batch">Morning Batch</option>
												<option value="Summar Special Batch">Summar Special
													Batch</option>
												<option value="Winter Special Batch">Winter Special
													Batch</option>
										...
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-prepend">
													<span
														class="input-group-text bg-gradient-primary text-white">Registration
														Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
												</div>
												<input type="text" class="form-control-sm"
													aria-label="Amount (to the nearest dollar)" id="rgamt" value="0" onblur="calTot();">
												...
												<div class="input-group-prepend">
													<span
														class="input-group-text bg-gradient-primary text-white">Plan
														Amount
														Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
												</div>
												<input type="text" class="form-control-sm"
													aria-label="Amount (to the nearest dollar)" id="plamt" value="0" onblur="calTot();">
												<div class="input-group-append">
													<span class="input-group-text">.00</span>
												</div>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-prepend">
													<span
														class="input-group-text bg-gradient-primary text-white">Other
														Charges Rs.</span>
												</div>
												<input type="text" class="form-control-sm"
													aria-label="Amount (to the nearest dollar)" id="otamt" value="0" onblur="calTot();">
												<div class="input-group-append">
													<span class="input-group-text">.00</span>
												</div>
												&nbsp;&nbsp;&nbsp;
												<div class="input-group-prepend">
													<span
														class="input-group-text bg-gradient-primary text-white">Discount
														Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
												</div>
												<input type="text" class="form-control-sm"
													aria-label="Amount (to the nearest dollar)" id="dscamt" value="0" onblur="calTot();">
												<div class="input-group-append">
													<span class="input-group-text">.00</span>
												</div>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-prepend">
													<span
														class="input-group-text bg-gradient-primary text-white">Grand
														Total Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
												</div>
												<input type="text" class="form-control-sm"
													aria-label="Amount (to the nearest dollar)" id="gtamt" value="0" readonly>
												<div class="input-group-append">
													<span class="input-group-text">.00</span>
												</div>
												&nbsp;&nbsp;&nbsp;
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="date" class="form-control"  id="sdate" placeholder="dd/MM/yyyy"/>
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<input type="date" class="form-control" id="edate" placeholder="dd/MM/yyyy"/>
													</div>
												</div>
											</div>
										</div>
