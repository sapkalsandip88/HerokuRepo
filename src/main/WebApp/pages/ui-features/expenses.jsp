...
function validate()
{
	if(document.getElementById("paidto").value=="")
		{
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Expense Module</h4>
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="paidto">Paid to</label>
                        <input type="text" class="form-control" id="paidto" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="particular">Particulars</label>
                        <input type="text" class="form-control" id="particular" placeholder="Particulars">
                      </div>
                      <div class="form-group">
                        <label for="paidamt">Amount</label>
                        <input type="text" class="form-control" id="paidamt"  value="0">
                      </div>
                      <div class="form-group">
										...
										<div class="form-group">
											<label for="billno">Bill No.</label> <input type="text"
												class="form-control" id="billno" placeholder="Bill No.">
										</div>
										<div class="form-group">
											<label for="refno">Ref. No.</label> <input type="text"
												class="form-control" id="refno" placeholder="Ref. No.">
										</div>
                      <div class="form-group">
