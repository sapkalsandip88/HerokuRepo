                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="mobileno" placeholder="Mobile No">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input class="form-control" id=""occupation"" placeholder="Occupation" />
                      </div>
                      <div class="form-group">
                        <label for=""blgroup"">Blood Group</label>
                        <select class="form-control" id="blgroup">
                      ...
                      <div class="form-group">
                          <label for="refby">Refer By</label>
                          <input type="text" class="form-control" id="refby" placeholder="Refer By / How you get to know about us" />
                      </div>
                      <div class="form-group">
