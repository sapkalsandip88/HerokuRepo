                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="mobileno" placeholder="Password">
                      </div>
                      <div class="form-group">
                          <label for="sdob">Date of Birth</label>
                          <input type="date"  class="form-control" id="sdob" placeholder="dd/mm/yyyy" />
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="date" class="form-control" id="doj" placeholder="dd/mm/yyyy" />
                      </div>
                      <div class="form-group">
                          <label for="dor">Date of Resignation</label> 
