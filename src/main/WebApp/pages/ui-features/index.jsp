...
<html lang="en">
<head>
<!-- Required meta tags    https://gym.maxerp.org/  -->
<meta charset="utf-8">
<meta name="viewport"
					...
					<li class="nav-item"><a class="nav-link"
						...
						<div class="collapse" id="ui-basic">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/category.jsp">Category</a></li>
								<li class="nav-item"><a class="nav-link"
									href="../../categoryList">View Category</a></li>
								
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/plan.jsp">Plan</a></li>
									<li class="nav-item"><a class="nav-link"
									href="../../planList">View Plan</a></li>
								<li class="nav-item"><a class="nav-link"
						...
						<li class="nav-item"><a class="nav-link"
						data-toggle="collapse" href="#ui-basicm" aria-expanded="false"
						aria-controls="ui-basicm"> <span class="menu-title">Member</span>
						...
						<div class="collapse" id="ui-basicm">
							<ul class="nav flex-column sub-menu">
								...
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/subscription.jsp">Subscription</a></li>
									<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/attendence.jsp">Attendence</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
						data-toggle="collapse" href="#ui-basica" aria-expanded="false"
						aria-controls="ui-basica"> <span class="menu-title">Accounts</span>
							<i class="menu-arrow"></i> <i class="mdi mdi-contacts menu-icon"></i>
					</a>
						<div class="collapse" id="ui-basica">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/receipt.jsp">Receipt</a></li>
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/expenses.jsp">Expenses</a></li>
									<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/provider.jsp">Provider</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
						data-toggle="collapse" href="#ui-basice" aria-expanded="false"
						aria-controls="ui-basic1"> <span class="menu-title">Enquiry</span>
							<i class="menu-arrow"></i> <i class="mdi mdi-contacts menu-icon"></i>
					</a>
						<div class="collapse" id="ui-basice">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/enquiry.jsp">Enquiry</a></li>
								<li class="nav-item"><a class="nav-link"
									href="pages/ui-features/showenquiry.jsp">Enquiry Details</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
